...
describe('Account Settings', () => {
  ...
  it('account info & edit profile', {
    ...
    cy.cyGet('account-submit-button').click({ force: true })
  })
  ...
  /**
   * If user exceeds the limit of saved payment methods on Stripe, use the following script
   * Script: https://github.com/flocasts/stripe-scripts/blob/main/detachPaymentMethods.js
   * See README.md that explains how to use the script: https://github.com/flocasts/stripe-scripts/tree/main
   */
